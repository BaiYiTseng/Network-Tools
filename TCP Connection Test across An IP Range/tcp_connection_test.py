...
# Connections to the hosts in the range will be tested concurrently
# Output: printing on the screen or saving as a txt file
...
def main():
    network_range = input("Please enter network range in CIDR: ")
    ...
    file_name = input("As what file name would you like to save the output?\nClick on \"Enter\" to print it directly on the screen: ")    
